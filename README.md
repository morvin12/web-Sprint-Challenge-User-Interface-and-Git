...
-It describes the meaning of the element to both the browser and the developer.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

- display block is displayed as a block and takes up the full width available.
...
- It allows developer to collaborate, maintain version control, and has branching/cloning abilities. 
